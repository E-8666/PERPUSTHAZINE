...
<html lang="en">
    <head>
        ...
        <title>Perpusthazine</title>
        
        <link rel="shortcut icon" type="image/png" href="{{ asset('admin/assets/img/favicon.ico') }}"/>
        ...
        <style>
        .navbar-black {
            background: linear-gradient(to bottom, #ff0013, #000000);
        }
        </style>
    </head>

    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-black bg-linear-gradient">
            <!-- Navbar Brand-->
            
            <a class="navbar-brand ps-4" href="/"> <img src="{{asset('admin/assets/img/Untitled-1.png')}}" width="130px" > </a>
            <!-- Sidebar Toggle-->
